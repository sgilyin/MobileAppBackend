...
class BGBilling {
    ...
    public static function getBalanceYandex($requestJson){
        ...
        $balanceText = (empty($balance)) ? 'Для получения баланса сообщите лицевой счет, указанный в договоре. Можно указать либо код целиком, либо часть кода, идущую после нулей.' : "Ваш баланс в рублях: $balance";
