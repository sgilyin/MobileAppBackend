...
Чтобы поменять тарифный план или отключить наши услуги абоненту, на которого оформлен договор, необходимо подойти с паспортом в кассу и написать соответствующее заявление.
';
                break;
            case 'address':
